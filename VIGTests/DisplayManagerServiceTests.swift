...
final class DisplayManagerServiceTests: XCTestCase {
    ...
    func testMockCreateSetsHasOverlays() {
        ...
        svc.createOverlayWindows(style: .darkDimmed, mode: .obscured, onUnlock: {})
    ...
    func testMockCapturesOnUnlockCallback() {
        let svc = MockDisplayManagerService()
        var fired = false
        svc.createOverlayWindows(style: .darkDimmed, mode: .obscured, onUnlock: { fired = true })
    ...
    func testMockRecordsLastMode() {
        let svc = MockDisplayManagerService()
        svc.createOverlayWindows(style: .darkDimmed, mode: .visible, onUnlock: {})
